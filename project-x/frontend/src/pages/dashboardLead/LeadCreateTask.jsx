...
function LeadCreateTask() {
  ...
  const handleSubmit = (e) => {
    ...
    if (!formData.assignedTo) newErrors.assignedTo = "Select a staff member";
    ...
    const assignedStaff = staff.find((m) => m.username === formData.assignedTo);

    addTask({
      title: formData.title,
      description: formData.description,
      assignedTo: formData.assignedTo,
      assignedToName: assignedStaff?.name || formData.assignedTo,
