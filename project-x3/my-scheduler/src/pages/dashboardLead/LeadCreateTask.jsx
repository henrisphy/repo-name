        ...
        comments: [
          {
            ...
            userName: user.name,
            text: `Task "${formData.title}" has been created and assigned to ${
              assignedMember?.name || formData.assignedTo
            }`,
  ...
  return (
    <div>
      <div className="dashboardHeader">
        ...
        <ButtonActionNegative onClick={() => navigate("/dashboard/lead/tasks")}>
          Back
        </ButtonActionNegative>
      </div>
